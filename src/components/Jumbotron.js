  ...
  return (
	...
	<section class="slider-wrapper">
			<div class="slider-start slider-1 owl-carousel owl-theme">
				...
				<div class="item">
					<img src="media/images/banner/f2.png" alt=""/>
				...
				<div class="item f1page">
					<img src="media/images/banner/f1.png" alt=""/>
					<div class="container-fluid custom-container slider-content ">
						<div class="row align-items-center">
				...
				<div class="item">
					<img src="media/images/banner/f3.png" alt=""/>
					<div class="container-fluid custom-container slider-content">
						<div class="row align-items-center">
							<div class="col-12 col-sm-8 col-md-8 offset-md-2 col-lg-6 offset-xl-1 col-xl-5 mr-auto">
